...
/***/ function(module, exports, __webpack_require__) {
	...
	var StarRating = function (_React$Component) {
	  ...
	  function StarRating(props) {
	    ...
	    _this.onSelectRating = function (val) {
	      _this.props.onChange(val, _this.props.value);
	    };

	    _this.onMouseEnterStar = function (val) {
	      _this.setState({
	        hoverCount: val
	      });
	    };

	    _this.onMouseLeaveStar = function () {
	      _this.setState({
	        hoverCount: 0
	      });
	    };

	    _this.renderStars = function (size) {
	      var stars = [];
	      var hoverCount = _this.state.hoverCount;
	      var numOfStarsToRender = hoverCount === 0 ? _this.props.value : hoverCount;

	      for (var i = 0; i < size; i++) {
	        var isOn = i < numOfStarsToRender;
	        stars.push(_this.renderStarIcon(isOn, i + 1));
	      }
	  ...
	  _createClass(StarRating, [{
	    key: 'renderStarIcon',
	    value: function renderStarIcon(isOn, valueOfStar) {
	      return _react2.default.createElement(
	        'span',
	        {
	          key: valueOfStar,
	          className: isOn ? _index2.default.on : _index2.default.off,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".index__root___1g6PR {\n  unicode-bidi: bidi-override;\n  font-size: 25px;\n  margin: 0 auto;\n  cursor: pointer;\n  position: relative;\n  padding: 0;\n}\n\n.index__on___2g4jr {\n  color: #e93434;\n}\n\n.index__off___XV37k {\n  color: #ddd;\n}\n", "", {"version":3,"sources":["/./index.css"],"names":[],"mappings":"AAKA;EACE,4BAA4B;EAC5B,gBAAgB;EAChB,eAAe;EACf,gBAAgB;EAChB,mBAAmB;EACnB,WAAW;CACZ;;AAED;EACE,eAA6B;CAC9B;;AAED;EACE,YAAmB;CACpB","file":"index.css","sourcesContent":[":root {\n  --gray: #ddd;\n  --accent-primary: #e93434;\n}\n\n.root {\n  unicode-bidi: bidi-override;\n  font-size: 25px;\n  margin: 0 auto;\n  cursor: pointer;\n  position: relative;\n  padding: 0;\n}\n\n.on {\n  color: var(--accent-primary);\n}\n\n.off {\n  color: var(--gray);\n}\n"],"sourceRoot":"webpack://"}]);

	// exports
	exports.locals = {
		"root": "index__root___1g6PR",
		"on": "index__on___2g4jr",
		"off": "index__off___XV37k"
	};
